...
<form action="registration.php" method="POST">
                            <div class="sign-up-htm">
                                ...
                                <div class="group">
                                    ...
                                    <label for="user" style="margin-top:12px" class="label">Male: <input id="user" type="radio" value="Male"  name="gender" checked>&nbsp&nbsp&nbspFemale:<input id="user" value="Female" type="radio"  name="gender"></label>
    ...
    <div id="webtitle">
        <div class="card-body">
            <h1 class="card-title text-center">Oranda <br> 
            <div style="Font-size:0.20in;">A Farmer's Friend</div> 
         </h1>
        </div>
    </div>
